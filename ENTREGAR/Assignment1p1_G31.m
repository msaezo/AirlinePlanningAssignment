...
cplex.Param.timelimit.Cur = 5*60; %Timelimit of the solver in seconds, more useful for larger models
% cplex.Param.mipgap.Cur = 60; %Timelimit of the solver in seconds, more useful for larger models
cplex.solve();
...
% Gap_between_OandBI = Cplex.Param.mip.tolerances.mipgap;
%% Post-Processing
